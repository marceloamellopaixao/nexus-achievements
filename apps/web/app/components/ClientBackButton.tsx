...
export default function ClientBackButton({ title, href, className }: ClientBackButtonProps) {
  ...
  const defaultClass = "absolute top-0 left-0 z-20 inline-flex items-center gap-2 px-4 py-2 bg-background/40 backdrop-blur-md border border-white/10 text-gray-300 hover:text-white hover:bg-white/10 rounded-xl font-bold text-sm transition-all shadow-lg active:scale-95 cursor-pointer";
